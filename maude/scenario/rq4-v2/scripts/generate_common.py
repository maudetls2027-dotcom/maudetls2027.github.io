#!/usr/bin/env python3
"""Generate RQ4-v2 full-catalog BehaviorDVSpec sets.
...
RQ4_V2_DIR = Path(__file__).resolve().parents[1]
SCENARIO_DIR = RQ4_V2_DIR.parent
REPO = SCENARIO_DIR.parent.parent
MAUDE_DIR = REPO / "maude"
RFC_DIR = SCENARIO_DIR / "rfc"
OUT_FILE = RQ4_V2_DIR / "common.maude"
...
RFC_AGGREGATE_OP = "rq4v2RfcBehaviorDVSpecSet"
SYNTHETIC_PREFIX = "rq4v2SyntheticCipherBlock"
COMMON_BEHAVIOR_ID = "'rq4v2-full-bdv"
...
def main() -> None:
    ...
    rendered: list[str] = [
        ...
        "",
        "smod RQ4-V2-PRE-DEFINED-BEHAVIOR-DEVIATION-SPECIFICATION is",
